...
# Launch all CAs
```bash
docker-compose -f docker-compose-cas.yaml up
```
...
fabric-ca-client register -d --id.name admin-athen.universet.at --id.secret athenAdminPW --id.type admin -u https://0.0.0.0:7054
...
cp fabca/crypto-config/peerOrganizations/athen.universe.at/users/Admin@athen.universe.at/msp/signcerts/cert.pem fabca/crypto-config/peerOrganizations/athen.universe.at/peers/peer0.athen.universe.at/msp/admincerts/admin-athen-cert.pem
...
```bash
export FABRIC_CA_CLIENT_TLS_CERTFILES=${PWD}/fabca/crypto-config/ca-orderer/universe.at/tls-cert.pem
export FABRIC_CA_CLIENT_HOME=$PWD/fabca/crypto-config/ordererOrganizations/universe.at/orderers/orderer.universe.at
...
cp fabca/crypto-config/ordererOrganizations/universe.at/users/Admin@universe.at/msp/signcerts/cert.pem fabca/crypto-config/ordererOrganizations/universe.at/users/Admin@universe.at/msp/admincerts/Admin@universe.at-cert.pem
...
mv fabca/crypto-config/peerOrganizations/athen.universe.at/users/Admin@athen.universe.at/msp/cacerts/0-0-0-0-7054.pem fabca/crypto-config/peerOrganizations/athen.universe.at/users/Admin@athen.universe.at/msp/cacerts/ca.athen.universe.at-cert.pem 
...
configtxgen -profile OneOrgChannel -outputAnchorPeersUpdate $PWD/fabca/config/AthenMSPanchors.tx -channelID samlinux -asOrg AthenMSP
```
...
export CORE_PEER_MSPCONFIGPATH="/root/crypto-config/peerOrganizations/athen.universe.at/peers/peer0.athen.universe.at/msp/"
docker exec -e $CORE_PEER_MSPCONFIGPATH cli peer channel create -c samlinux -f /root/config/channel.tx -o orderer.universe.at:7050 --outputBlock /root/config/samlinux.block
````
